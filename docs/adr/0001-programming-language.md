...
- **Legacy Compatibility (Python 3.4)**: Python 3.4.4 is the final official Python release that runs natively on Windows XP SP3. Adopting a Python 3.4 baseline allows Atlas to support older hardware while retaining modern Python 3 foundations.
